...
export const DEVICE_MODELS: DeviceModelInfo[] = [
  // --- iPhone Models ---
  {
    ...
    aspectRatio: '19.5:9',
    recommendedResolution: '1320 x 2868',
    description: '超極窄鈦金屬邊框・動態島・旗艦 6.9 吋螢幕 (ASC: 1320 × 2868 或 1260 × 2736)',
  },
  {
    id: 'iphone-16-pro',
    name: 'iPhone 16 Pro',
...
export const APP_STORE_SPECS: AppStoreSpec[] = [
  // ==================== iOS App Store Specs ====================
  {
    ...
    name: 'iPhone 6.9" (1320 × 2868 px)',
    category: 'iPhone',
    store: 'app-store',
    width: 1320,
    height: 2868,
    aspectRatio: '9:19.5 (1:2.173)',
    recommendedDevice: 'iphone-16-pro-max',
    description: 'Apple ASC 官方 6.9 吋推薦標準規格 (1320 × 2868 px，iPhone 16 Pro Max 旗艦)',
    required: true,
  },
  {
    id: 'iphone-6.9-1260x2736',
    name: 'iPhone 6.9" (1260 × 2736 px)',
    category: 'iPhone',
    store: 'app-store',
    width: 1260,
    height: 2736,
    aspectRatio: '9:19.5 (1:2.171)',
    recommendedDevice: 'iphone-16-pro-max',
    description: 'Apple ASC 官方 6.9 吋替代規格 (1260 × 2736 px)',
    required: true,
  },
  {
    id: 'iphone-6.9-landscape-2868x1320',
    name: 'iPhone 6.9" 橫向 (2868 × 1320 px)',
    category: 'iPhone',
    store: 'app-store',
    width: 2868,
    height: 1320,
    aspectRatio: '19.5:9 (2.173:1)',
    recommendedDevice: 'iphone-16-pro-max',
    description: 'Apple ASC 官方 6.9 吋橫向規格 (2868 × 1320 px)',
    required: false,
  },
  {
    id: 'iphone-6.9-landscape-2736x1260',
    name: 'iPhone 6.9" 橫向 (2736 × 1260 px)',
    category: 'iPhone',
    store: 'app-store',
    width: 2736,
    height: 1260,
    aspectRatio: '19.5:9 (2.171:1)',
    recommendedDevice: 'iphone-16-pro-max',
    description: 'Apple ASC 官方 6.9 吋橫向規格 (2736 × 1260 px)',
    required: false,
  },
  {
    id: 'iphone-6.7-1284x2778',
    name: 'iPhone 6.7" / 6.5" (1284 × 2778 px)',
    category: 'iPhone',
    store: 'app-store',
    width: 1284,
    height: 2778,
    ...
    recommendedDevice: 'iphone-16-pro-max',
    description: 'Apple 官方要求規格 (1284 × 2778 px，適用於 6.7" / 6.5" iPhone 12/13/14 系列)',
    required: true,
  },
  {
    id: 'iphone-6.5-1242x2688',
    name: 'iPhone 6.5" (1242 × 2688 px)',
    category: 'iPhone',
    store: 'app-store',
    width: 1242,
    height: 2688,
    aspectRatio: '9:19.5 (1:2.164)',
    recommendedDevice: 'iphone-15-pro-max',
    description: 'Apple 官方要求規格 (1242 × 2688 px，適用於 6.5" iPhone 11 Pro Max, XS Max)',
    required: true,
  },
  {
    id: 'iphone-6.7-landscape-2778x1284',
    name: 'iPhone 6.7" / 6.5" 橫向 (2778 × 1284 px)',
    category: 'iPhone',
    store: 'app-store',
    width: 2778,
    height: 1284,
    aspectRatio: '19.5:9 (2.164:1)',
    recommendedDevice: 'iphone-16-pro-max',
    description: 'Apple 官方橫向螢幕要求規格 (2778 × 1284 px)',
    required: false,
  },
  {
    id: 'iphone-6.5-landscape-2688x1242',
    name: 'iPhone 6.5" 橫向 (2688 × 1242 px)',
    category: 'iPhone',
    store: 'app-store',
    width: 2688,
    height: 1242,
    aspectRatio: '19.5:9 (2.164:1)',
    recommendedDevice: 'iphone-15-pro-max',
    description: 'Apple 官方橫向螢幕要求規格 (2688 × 1242 px)',
    required: false,
  },
  {
    id: 'iphone-6.7-1290x2796',
    name: 'iPhone 6.7" (1290 × 2796 px)',
    category: 'iPhone',
    store: 'app-store',
    width: 1290,
    height: 2796,
    ...
    recommendedDevice: 'iphone-15-pro-max',
    description: 'Apple App Store 動態島規格 (iPhone 15 Pro Max, 14 Pro Max)',
    required: false,
  },
  {
    id: 'iphone-6.1-6.3',
    name: 'iPhone 6.3" / 6.1" (1179 × 2556 px)',
    category: 'iPhone',
    store: 'app-store',
    width: 1179,
    height: 2556,
    ...
    description: 'Apple App Store 推薦規格 (iPhone 16 Pro, 15 Pro, 14 Pro)',
    required: false,
  },
  {
    id: 'iphone-5.5',
